...
**MOD**: In this fork I added a functionality to block mulitple **ASN**, instead of a single IP. Then I added a mechanism to detect and block requests originating from **Tor**.
